 ...
 * @author dux
 */
public class blicTestHtml extends blicTest{
    public blicTestHtml (int brPitanjaUTestu, int brTestova, String filename){
        doTest(brPitanjaUTestu, brTestova, filename);//defined in super class
        super.writeOutput(filename);//ukljuciti ovu opciju
    }
    ...
    for (int i = 0; i<brTestova;i++){
  	...
  	//FileWriter out = new FileWriter(folderName + "/" + outFile + String.valueOf(i+1) + ".html");
		//BufferedWriter outStream = new BufferedWriter (out);
                ...
                outStream.newLine();
                outStream.write("<h3><center>TESTNI LIST</center></h3>");
                outStream.newLine();
                ...
                for (int j=0;j<brPitanjaUTestu;j++){
                    ...
                    outStream.write("</p>");
                    outStream.newLine();
                    outStream.write("<br><br><br><br><hr>");
                    outStream.newLine();
                }
